...
class SistemaLojaGames:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("Vendas e Estoque")
    ...
    def criar_menu_principal(self):
        ...
        botoes = [
            ...
            ("📋 Listar Produtos", self.janela2_listar_jogos),
            ("✏️ Editar Produtos", self.janela3_editar_jogo),
            ("🗑️ Excluir Produtos", self.janela4_excluir_jogo),
            ("👥 Cadastrar Cliente", self.janela5_cadastrar_cliente),
            ("📊 Listar Clientes", self.janela6_listar_clientes),
            ("💰 Nova Venda", self.janela7_nova_venda),
            ("📈 Histórico Vendas", self.janela8_historico_vendas),
            ("📦 Estoque", self.janela9_estoque),
            ("🔍 Buscar Produto", self.janela10_buscar_jogo),
            ("📋 Relatório Vendas", self.janela11_relatorio_vendas),
        ]
    ...
    # JANELA 1 - Cadastrar Produto
    def janela1_cadastrar_jogo(self):
        janela = tk.Toplevel()
        janela.title("Cadastrar Produtos")
    ...
    # JANELA 4 - Excluir produto
    def janela4_excluir_jogo(self):
        janela = tk.Toplevel()
        janela.title("Excluir Produto")
        janela.geometry("300x150")
        
        tk.Label(janela, text="ID do Produto para excluir:").pack()
        id_entry = tk.Entry(janela)
        id_entry.pack()
